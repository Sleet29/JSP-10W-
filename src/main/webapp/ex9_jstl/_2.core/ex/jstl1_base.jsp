<%--
	...
	2) 이클립스에 파일 넣기
	   webapp / WEB-INF/lib/ (jakarta.servlet.jsp.jstl-3.0.1.jar, jakarta.servlet.jsp.jstl-api-3.0.0.jar/
--%>
...
<%-- * taglib 지시어: JSTL이나 커스텀 태그 등 태그 라이브러리를 JSP에서 사용할 때 접두사를 지정하기 위해 사용합니다.
		...
		* taglib 장점 : 사용하면 코드의 길이가 줄어들고 인식성 좋아짐.
--%>
...
<body>
	<%--<c:set> 변수에 값을 설정하는 태그입니다.
		 ...
		 value : 저장할 값
	--%>
	<c:set var="test" value="Heelo JSTL!" /> 
	...
	<h3>
		&lt; c:set&gt; 사용 후 :
		<c:out value = 'test'/> <!-- $기호 붙여야 원하는 방식으로 출력됨 -->
	</h3>
	...
	<h3>
		...
		<c:out value = '${a}' /><!-- 지정된 값을 출력하는 태그입니다. -->
	</h3>
